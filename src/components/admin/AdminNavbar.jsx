      ...
      <div className="flex flex-col justify-between pl-5 h-screen sticky top-0">
        <ul>
          ...
          <li>
            <NavItem to="/courses">
              <BiBookOpen />
              <span
              className="text-indigo-500  hover:text-white">Courses</span>
            </NavItem>
          </li>
          <li>
            <NavItem to="/instructors">
              <FaUserTie />
              <span
              className="text-indigo-500  hover:text-white"
              >Instructors</span>
        ...
        <div className="flex flex-col items-start pb-5">
          ...
          <button
            ...
            className="flex items-center  text-indigo-500	 text-sm hover:text-white transition space-x-1"
          >
            <FiLogOut />
            <span>Log out</span>
          </button>

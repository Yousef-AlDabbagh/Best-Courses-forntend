...
import { uploadTrailer, uploadCourse } from "../../api/course";
import { useNotification } from "../../hooks";
import ModalContainer from "../modals/ModalContainer";
import CourseForm from "./CourseForm";

export default function CourseUpload({ visible, onClose }) {
  ...
  const handleSubmit = async (data) => {
    ...
    const { error } = await uploadCourse(data);
    setBusy(false);

    if (error) return updateNotification("error", error);

    updateNotification("success", "Course uploads successfully.");
    resetState()
    onClose();
  };
